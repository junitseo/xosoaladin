...
const StatisticLayout = ({ children }: { children: ReactNode }) => {
    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="Xổ số ALADIN - thống kê - KQXS - XS - Xo so - CHÍNH XÁC 100%, SIÊU ĐẦY ĐỦ, SIÊU NHANH! Xem ngay kết quả xổ số cập nhật trực tiếp từ các công ty xổ số kiến thiết 3 MIỀN BẮC, TRUNG, NAM"
                />
                <meta
                    name="viewport"
